...
# from rllib_helpers.fcnet_me_torch import MyFullyConnectedNetwork  # Ensure this path matches your file structure

ModelCatalog.register_custom_model("MyFullyConnectedNetwork", MyFullyConnectedNetwork)
...
class DummyQuadrupedEnv(gym.Env):
    ...
    def __init__(self, env_config):
        ...
        self.env = QuadrupedGymEnv(time_step=0.001, action_repeat=30, obs_hist_len=1) # for illustrating necessity of horizon observation
...
model = {"fcnet_hiddens": [256, 64, 256], "fcnet_activation": "tanh", "vf_share_layers": True}
